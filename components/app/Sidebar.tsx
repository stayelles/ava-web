...
const AVA_DESKTOP_MAC_VERSION = '1.2.68'
const AVA_DESKTOP_WINDOWS_VERSION = '1.2.68'
const AVA_BRIDGE_EA_VERSION = '1.45'
...
const BRIDGE_DOWNLOADS = [
  {
    title: 'AvaBridgeEA 1.45',
    badge: 'Recommandé',
    subtitle: 'Ava Volatility Boom/Crash et Ava Trading moderne',
    href: `${DOWNLOAD_BASE_URL}/AvaBridgeEA-1.45.ex5`,
  },
  {
