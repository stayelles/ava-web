...
const AVA_DESKTOP_MAC_VERSION = '1.2.62'
const AVA_DESKTOP_WINDOWS_VERSION = '1.2.62'
const AVA_BRIDGE_EA_VERSION = '1.42'
...
const BRIDGE_DOWNLOADS = [
  {
    title: 'AvaBridgeEA 1.42',
    badge: 'Recommandé',
    subtitle: 'Ava Volatility Boom/Crash et Ava Trading moderne',
    href: `${DOWNLOAD_BASE_URL}/AvaBridgeEA-1.42.ex5`,
  },
  {
