...
const AVA_DESKTOP_MAC_VERSION = '1.2.67'
const AVA_DESKTOP_WINDOWS_VERSION = '1.2.67'
const AVA_BRIDGE_EA_VERSION = '1.44'
...
const BRIDGE_DOWNLOADS = [
  {
    title: 'AvaBridgeEA 1.44',
    badge: 'Recommandé',
    subtitle: 'Ava Volatility Boom/Crash et Ava Trading moderne',
    href: `${DOWNLOAD_BASE_URL}/AvaBridgeEA-1.44.ex5`,
  },
  {
