...
export const PAYPAL_PLAN_CUSTOM_PRO_TRIAL = process.env.NEXT_PUBLIC_PAYPAL_PLAN_CUSTOM_PRO_TRIAL ?? 'P-7CV53356AW904362UNIVRE6Y'
export const PAYPAL_PLAN_CUSTOM_ULTRA_TRIAL = process.env.NEXT_PUBLIC_PAYPAL_PLAN_CUSTOM_ULTRA_TRIAL ?? 'P-2JH34674RS63317OYNIVRGCA'
